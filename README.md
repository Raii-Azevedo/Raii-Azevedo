...
|--------|------------|-----------|
| Personal Portfolio | Modern portfolio website | Django, HTML, CSS, JS |
| E-commerce Platform | Online store | Django, PostgreSQL |
| Data Dashboard | Analytics dashboard | Power BI, Python |
| Task Manager API | REST API | Django REST |
